	...
	<div class="container">
		...
		<div class="col-lg-4">
			<div class="jumbotron" style="margin-top:20px";>
				<form method="POST" name="findId" action="./findIdAction.jsp" onSubmit="return check_Find_Id();">
					<center><h2>아이디 찾기</h2></center>
					<center>이름과 이메일 입력</center>
					...
					<p><button class="form-control" type="submit" value="findId"> 아이디 찾기 </button></p>
				</form>
		    </div> 
	    </div>
	    <div class="col-lg-4"></div>
